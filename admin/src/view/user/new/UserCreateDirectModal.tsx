...
import UserCreateDirectForm from 'src/view/user/new/UserCreateDirectForm';
import Errors from 'src/modules/shared/error/errors';
import UserService from 'src/modules/user/userService';

function UserCreateDirectModal(props) {
...
export default UserCreateDirectModal;
